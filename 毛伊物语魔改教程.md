...
**使用方法**
mods.mariculture.Crucible.addRecipe(融化温度, 输入物品, <u>输出流体</u>, <u>输出物品</u>, <u>输出物品生成概率</u>);</br>
注意:其中输出物品生成概率为n时，实际概率为(100/n)%</br>
话说这里的输出居然都可以省略，原文如此，我自己暂未测试，这里对原文不做修改。
**实例**
...
**使用方法**</br>
垃圾</br>
mods.mariculture.Fishing.addJunk(掉落物品, 概率, <u>钓竿种类(String)</u>, <u>匹配特定钓竿</u>, <u>维度数组</u>);</br>
宝藏</br>
mods.mariculture.Fishing.addGood(掉落物品, 概率, <u>钓竿种类(String)</u>, <u>匹配特定钓竿</u>, <u>维度数组</u>);</br>
